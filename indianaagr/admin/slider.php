...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php if(!empty($_SESSION['sliderstatus']) &&  $_SESSION['sliderstatus']=="invalid" ) { ?>
                <div class="alert alert-danger" role="alert">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <h4>Invalid!</h4>
                    <?php echo $errorlist['slider'][$_SESSION['sliderstatus']]; ?>
                </div>
                <div class="clearfix"></div>
                <?php unset($_SESSION['sliderstatus']);
                } elseif(!empty($_SESSION['sliderstatus']) &&  $_SESSION['sliderstatus']!="invalid") {
                ?>
            ...
            <div class="middlesection margin-top20">
                ...
                <?php
                    if (!empty($_GET['edit']) && (int)$_GET['edit'] == 1) {
                        ...
                        $id     =   (int)$_GET['id'];
                         ...
                         $sqlquery = $fpdo->from('tblsliders')
                                          ->where('tblsliders.id = :id', array(":id" => $id));
                        $rsdata   = $sqlquery->fetchAll();
                        if(count($rsdata) > 0) {
                            foreach($rsdata as $rowdata ) {
                                $title          =   trim($rowdata['title']);
                                $link_url       =   trim($rowdata['link_url']);
                ...
                ?>
                <form name="addform" id="addform" method="post" action="slidersave.php" enctype="multipart/form-data" target="_self">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        <tbody>
                            <tr>
                                ...
                                <td class="col-md-9">
                                    <div class="col-md-9">
                                        <input type="text" name="title" id="title" value="<?php echo $title; ?>" maxlength="150" class="required form-control" placeholder="Enter Title" title="Please enter title"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><div class="text-right">Link URL<span class="text-danger">*</span></div></td>
                                <td>
                                    <div class="col-md-9">
                                        <input type="text" name="link_url" id="link_url" value="<?php echo $link_url; ?>" maxlength="150" class="required form-control" placeholder="Enter Link URL" title="Please enter link url"/>
                                    </div>
                                </td>
                            </tr>
                            
                            <?php if(!empty($big_image) && (int)$DB->checkfileexist("../uploads/sliders/".$big_image."") == 707) { ?>
                                <tr>
                                    <td><div class="text-right">Previously Uploaded Big Image</div></td>
                                    <td>
                                        <div class="col-md-9">
                                            <img src="../uploads/sliders/<?php echo $big_image; ?>" style="max-width:600px;" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-9">
                                            <a href="<?php echo "../uploads/sliders/".$big_image; ?>" download="<?php echo $big_image; ?>" class="btn btn-sm btn-info">Download File</a>
                                            &nbsp; <a href="deletesliderfile.php?id=<?php echo $id;?>&filename=<?php echo $big_image; ?>&filetype=big_image&delete=1" class="btn btn-sm btn-danger adelete">Delete File</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-9">
                                        <input type="file" name="big_image" id="big_image" class="control" /><span class="text-danger">Best Size (width x height): 1360px X 520px | Best file format JPG</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6">
                                        <!--<a href="displaypress.php" class="btn btn-warning"><i class="fa fa-undo"></i> Cancel</a>-->
