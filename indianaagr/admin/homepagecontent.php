...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php if(!empty($_SESSION['homepagecontentstatus']) &&  $_SESSION['homepagecontentstatus']=="invalid" ) { ?>
                ...
                } elseif(!empty($_SESSION['homepagecontentstatus']) &&  $_SESSION['homepagecontentstatus']!="invalid") {
                ?>
            ...
            <div class="middlesection margin-top20">
                    ...
                    if (!empty($_GET['edit']) && (int)$_GET['edit'] == 1) {
                        ...
                        $id     =   (int)$_GET['id'];
                         ...
                         $sqlquery = $fpdo->from('tblhome_page_contents')
                                          ->where('tblhome_page_contents.id = :id', array(":id" => $id));
                ...
                ?>
                <form name="addform" id="addform" method="post" action="homepagecontentsave.php" enctype="multipart/form-data" target="_self">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        <tbody>
                            ...
                            <?php if(!empty($big_image) && (int)$DB->checkfileexist("../uploads/images/".$big_image."") == 707) { ?>
                                <tr>
                                    <td><div class="text-right">Previously Uploaded Big Image</div></td>
                                    <td>
                                        <div class="col-md-9">
                                            <img src="../uploads/images/<?php echo $big_image; ?>" style="max-width:600px;" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-9">
                                            <a href="<?php echo "../uploads/images/".$big_image; ?>" download="<?php echo $big_image; ?>" class="btn btn-sm btn-info">Download File</a>
                                            &nbsp; <a href="deletehomepagecontentfile.php?id=<?php echo $id;?>&filename=<?php echo $big_image; ?>&filetype=big_image&delete=1" class="btn btn-sm btn-danger adelete">Delete File</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-9">
                                        <input type="file" name="big_image" id="big_image" class="control" /><span class="text-danger">Best Size (width x height): 1360px X 544px | Best file format JPG</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
