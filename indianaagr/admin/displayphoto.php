...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="pull-right"><a href="photo.php" class="btn btn-info"><i class="fa fa-plus-circle"></i> Add Photo</a></div>
            <div class="clearfix"></div>
            <div class="middlesection margin-top20">
                <?php
                    ...
                    $sqlquery = $fpdo->from('tblphotos')
                                     ->order('tblphotos.sort_order = 0, tblphotos.sort_order ASC');
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-4">Photo Name</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $rowdata['photo_title']; ?></td>
                                        <td><?php if(!empty($rowdata['thumb_image'])){ ?><img src="../uploads/photos/<?php echo $rowdata['thumb_image']; ?>" max-width="150" height="100"/><?php } ?></td> 
                                        ...
                                        <td><a href="photo.php?id=<?php echo $rowdata['id']; ?>&edit=1" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Modify</a>  &nbsp; <a href="javascript:void(0);" data-id="<?php echo $rowdata['id']; ?>" class="btn btn-sm btn-danger adelete" data-toggle="modal" data-target="#modalDelete"><i class="fa fa-trash"></i> Delete</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="myDeleteLabel">Delete Photo?</h4>
                              </div>
                              <div class="modal-body">
                               <p>You have selected to delete this photo.</p>
                               <p>
                              ...
                              <div class="modal-footer">
                                <form name="frmdelete" id="frmdelete" method="post" action="deletephoto.php">
