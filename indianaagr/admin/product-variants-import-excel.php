...
<div class="container">
    <h3>Product Variants Import Excel</h3>
    <div class="col-md-12"><div class="blank-border"></div></div>
    <?php if(!empty($_SESSION['productimportstatus'])) { ?>
    ...
    <div class="middlesection margin-top20">
        ...
        <form name="addform" id="addform" method="post" action="product-variants-import-excel-save.php" enctype="multipart/form-data">
            ...
            <table class="table table-bordered table-striped table-condensed">
                ...
                ?>
                <tr>
                    <td colspan="2" class="text-right"><a href="<?php echo DISPLAY_PATH; ?>/excels/products-import-excel-sample.xls" download="products-export-excel-sample.xls" class="btn btn-info"><i class="fa fa-download"></i> Download Sample Format</a></td>
                </tr>
                <tr>
                    <td class="text-right col-md-5">Select Product Variants Inventory File<span class="text-danger">*</span></td>
                    <td>
