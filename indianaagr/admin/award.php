            ...
            <div class="middlesection margin-top20">
                ...
                if (!empty($_GET['edit']) && (int) $_GET['edit'] == 1) {
                    ...
                    $sqlquery = $fpdo->from('tblawards')
                            ->where('tblawards.id = :id ', array(":id" => $id));
                ...
                ?>
                <form name="addform" id="addform" method="post" action="awardsave.php" enctype="multipart/form-data" target="_self">
...
<?php if (!empty($big_image) && (int) $DB->checkfileexist("../uploads/awards/" . $big_image . "") == 707) { ?>
                                <tr>
                                    <td><div class="text-right">Previously Uploaded Big Image</div></td>
                                    <td>
                                        <div class="col-md-9">
                                            <img src="../uploads/awards/<?php echo $big_image; ?>" style="max-width:600px;" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
