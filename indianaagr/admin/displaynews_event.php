        ...
        <div class="container">
            ...
            <?php if(!empty($_SESSION['photostatus']) && $_SESSION['photostatus'] != "invalid") { ?>
                <div class="alert alert-success">
                    ...
                    <h4>Success!</h4>
                    <?php echo $errorlist['news-event'][$_SESSION['photostatus']]; ?>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="pull-right"><a href="news-event.php" class="btn btn-info"><i class="fa fa-plus-circle"></i> Add News & Events</a></div>
            <div class="clearfix"></div>
            <div class="middlesection margin-top20">
                <?php
                    ...
                    $sqlquery = $fpdo->from('tblnews_event')
                                     ->order('tblnews_event.sort_order = 0, tblnews_event.sort_order ASC');
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="news-event.php?id=<?php echo $rowdata['id']; ?>&edit=1" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Modify</a>  &nbsp; <a href="javascript:void(0);" data-id="<?php echo $rowdata['id']; ?>" class="btn btn-sm btn-danger adelete" data-toggle="modal" data-target="#modalDelete"><i class="fa fa-trash"></i> Delete</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="myDeleteLabel">Delete News & event?</h4>
                              </div>
                              <div class="modal-body">
                               <p>You have selected to delete this News & event.</p>
                               <p>
                              ...
                              <div class="modal-footer">
                                <form name="frmdelete" id="frmdelete" method="post" action="deletenews-event.php">
