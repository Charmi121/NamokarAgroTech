<?php
    ...
    $objPHPExcel = $objectReader->load("excel/usa.xls");
    ...
    print_r($sheetData[1]['C']);

    /*  
     //see also the following link
     //http://blog.mayflower.de/561-Import-and-export-data-using-PHPExcel.html  ----------- import in another style around 5000 records ------
    ...
    $objPHPExcel = $objReader->load("excel/usa.xlsx");
