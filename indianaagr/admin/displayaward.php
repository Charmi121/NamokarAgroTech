...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="pull-right"><a href="award.php" class="btn btn-info"><i class="fa fa-plus-circle"></i> Add Awards</a></div>
            <div class="clearfix"></div>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-4">Award Name</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php if(!empty($rowdata['thumb_image'])){ ?><img src="../uploads/awards/<?php echo $rowdata['thumb_image']; ?>" max-width="150" height="100"/><?php } ?></td> 
                                        ...
                                        <td><a href="award.php?id=<?php echo $rowdata['id']; ?>&edit=1" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Modify</a>  &nbsp; <a href="javascript:void(0);" data-id="<?php echo $rowdata['id']; ?>" class="btn btn-sm btn-danger adelete" data-toggle="modal" data-target="#modalDelete"><i class="fa fa-trash"></i> Delete</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="myDeleteLabel">Delete Awards?</h4>
                              </div>
                              <div class="modal-body">
                               <p>You have selected to delete this Awards.</p>
                               <p>
                              ...
                              <div class="modal-footer">
                                <form name="frmdelete" id="frmdelete" method="post" action="deleteaward.php">
