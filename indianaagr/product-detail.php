			 ...
			 <input type="hidden" name="seo_url" value="<?=$seo_url;?>" >
                <div class="form-group">
                    <label>Describe Your Buying Requirements in Detail</label>
                     <textarea class="form-control mb-4 required" name="requirement" required title="Please enter requirement" ></textarea>
                </div>
                <div class="row no-gutters">
                    ...
                    <div class="form-group col-md-4">
                        <label>Website</label>
                        <input type="text" class="form-control"  placeholder="">
						<label style="font-size: 11px;color: #a59898;">For Example: http://www.abc.com</label>
                    </div>
