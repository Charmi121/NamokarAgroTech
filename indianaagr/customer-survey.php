                    ...
                    <fieldset>
                        ...
                        <div class="row p-3">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="checkbox">
                                    <label><input type="radio" name="dbrand_opt" value="Yes"> Yes</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="dbrand_opt" value="No"> No</label>
                                </div>
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row p-3">
                            <div class="form-group col-md-12">
                                ...
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt" value="Great"> Great</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt" value="Good"> Good</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt" value="Average"> Average</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt" value="Disappointing"> Disappointing</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt1" value="Yes"> Yes</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt1" value="No"> No</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="prod_opt1" value="Not Yet Used"> Not Yet Used</label>
                                </div>
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row p-3">
                            <div class="form-group col-md-12">
                                ...
                                <div class="checkbox">
                                    <label><input type="radio" name="purchase_opt" value="Yes"> Yes</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="purchase_opt" value="No"> No</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label>If you have used Agrovision implement, are you pleased?</label>
                                <div class="checkbox">
                                    <label><input type="radio" name="purchase_opt1" value="Yes"> Yes</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="purchase_opt1" value="No"> No</label>
                                </div>
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row p-3">
                            <div class="form-group col-md-12">
                                ...
                                <div class="checkbox">
                                    <label><input type="radio" name="operat_opt" value="Yes"> Yes</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="operat_opt" value="No"> No</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="checkbox">
                                    <label><input type="radio" name="shape_opt" value="Yes"> Yes</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="radio" name="shape_opt" value="No"> No</label>
                                </div>
                            </div>
