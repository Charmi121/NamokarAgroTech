...
$dbrand_opt = (!empty($_POST['dbrand_opt']) ) ? $_POST['dbrand_opt'] : '';
$dbrandopt=foropt($dbrand_opt);

$prod_opt = (!empty($_POST['prod_opt']) ) ? $_POST['prod_opt'] : '';
$prodopt=foropt($prod_opt);

$prod_opt1= (!empty($_POST['prod_opt1']) ) ? $_POST['prod_opt1'] : '';
$prodopt1=foropt($prod_opt1);

$purchase_opt= (!empty($_POST['purchase_opt']) ) ? $_POST['purchase_opt'] : '';
$purchaseopt=foropt($purchase_opt);

$purchase_opt1= (!empty($_POST['purchase_opt1']) ) ? $_POST['purchase_opt1'] : '';
$purchaseopt1=foropt($purchase_opt1);

$operat_opt= (!empty($_POST['operat_opt']) ) ? $_POST['operat_opt'] : '';
$operatopt=foropt($operat_opt);

$shape_opt= (!empty($_POST['shape_opt']) ) ? $_POST['shape_opt'] : '';
