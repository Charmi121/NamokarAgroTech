        ...
        <div class="container">
            ...
            <form>
                ...
                <div class="row form-outerbox">
                    ...
                    <div class="form-group col-md-6">
                        <label class="control-label text-dark-light">Country</label>
                    ...
                    <div class="form-group jointeam-radio col-md-6">
                        <label class="control-label text-dark-light w-100">Products are you interested:</label>
