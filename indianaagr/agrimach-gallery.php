                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb mb-5">
                            <li><a href="<?php echo CONFIG_PATH; ?>index.html">Home</a></li>
                            <li><a href="<?php echo CONFIG_PATH; ?>photo-gallery.php">Photo Gallery</a></li>
                            <li>EIMA Agrimach India</li>
                        </ul>
                    </div>
                </div>
                <h2 class="h2 text-center pb-4">EIMA Agrimach India 2013<small class="d-block text-muted">(Thursday, December 05, 2013)</small></h2>
                <ul class="row list-inline lightgallery gallery-one justify-content-md-center">
                    <li class="col-md-3 col-6" data-src="<?php echo CONFIG_PATH; ?>images/agrimach1-big.jpg"><figure><img src="<?php echo CONFIG_PATH; ?>images/agrimach1.jpg" class="img-fluid" alt="EIMA Agrimach India 2013"></figure><span>EIMA Agrimach India 2013</span></li>
                    <li class="col-md-3 col-6" data-src="<?php echo CONFIG_PATH; ?>images/agrimach2-big.jpg"><figure><img src="<?php echo CONFIG_PATH; ?>images/agrimach2.jpg" class="img-fluid" alt="EIMA Agrimach India 2013"></figure><span>EIMA Agrimach India 2013</span></li>
                    <li class="col-md-3 col-6" data-src="<?php echo CONFIG_PATH; ?>images/agrimach3-big.jpg"><figure><img src="<?php echo CONFIG_PATH; ?>images/agrimach3.jpg" class="img-fluid" alt="EIMA Agrimach India 2013"></figure><span>EIMA Agrimach India 2013</span></li>
            </ul>
        </div>
           </div>
        <!-- Start footer -->
