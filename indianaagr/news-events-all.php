    ...
    <body>
        ...
        <div class="pb-5">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb mb-3">
                            ...
                            <a href="<?php echo CONFIG_PATH; ?>news-events.html">News & Events</a>
                            <li>All</li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="row list-inline gallery-one">
                    <?php if(!empty($categoryphoto)){
                        foreach($categoryphoto as $photo){ ?>
                            <li class="col-6" data-src="<?php echo CONFIG_PATH.'uploads/photos/'.$photo['big_image'];?>"><figure class="mb-0"><img src="<?php echo CONFIG_PATH.'uploads/photos/'.$photo['big_image'];?>" class="img-fluid" alt="Rotary Tiller"></figure><span><?php echo $photo['photo_title'];?></span></li>
                        <?php }
                    }
                    ?>
            </ul>
